...
\nolinkurl{ivo://ivoa.net/std/voevent#stream-2.1} as per
...
A public event stream MUST define at least one capability with a standard id of
\nolinkurl{ivo://ivoa.net/std/voevent#stream-2.1}.
...
\begin{lstlisting}
<capability standardID="ivo://ivoa.net/std/voevent#stream-2.1">
...
with capabilites whose \xmlel{standardID} attribute match standard
keys for VOEvent version 2 streams,
\nolinkurl{ivo://ivoa.net/std/voevent#stream-2.%} ignoring
case.
...
SELECT ivoid, res_title, cap_description, access_url
FROM rr.resource
NATURAL JOIN rr.capability
NATURAL JOIN rr.interface
WHERE standard_id ILIKE 'ivo://ivoa.net/std/voevent#stream-2.%'
\end{lstlisting}
...
WHERE
  standard_id ILIKE 'ivo://ivoa.net/std/voevent#stream-2.%'
